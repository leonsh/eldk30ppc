...
extern int ppc4xx_add_dma_sgl(sgl_handle_t handle, phys_addr_t src_addr, phys_addr_t dst_addr,	unsigned int count);
extern void ppc4xx_enable_dma_sgl(sgl_handle_t handle);
extern void ppc4xx_disable_dma_sgl(sgl_handle_t handle);
extern int ppc4xx_get_dma_sgl_residue(sgl_handle_t handle, phys_addr_t * src_addr, phys_addr_t * dst_addr);
extern int ppc4xx_delete_dma_sgl_element(sgl_handle_t handle, phys_addr_t * src_dma_addr, phys_addr_t * dst_dma_addr);
