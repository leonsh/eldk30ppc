/*
 * BK Id: SCCS/s.ns16550.c 1.20 11/08/01 12:29:33 trini
 */
/*
...
{
	u32	mpsc_adjust, sdma_adjust, brg_bcr, cdv;
	int	i;
	...
	cdv = ((CONFIG_GT64260_BRG_CLK_RATE/(32*CONFIG_SERIAL_CONSOLE_BAUD))-1);
	GT64260_REG_WRITE(brg_bcr,
		((CONFIG_GT64260_CLKSRC << 18) | (1 << 16) | cdv));
	...
	GT64260_REG_WRITE(GT64260_MPSC_0_CHR_2 + mpsc_adjust,
