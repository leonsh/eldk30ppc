...
#define PORT_DTR1_PAR immap->im_ioport.iop_ppara
#define PORT_DTR1_DAT immap->im_ioport.iop_pdata
#define PORT_DTR1_DIR immap->im_ioport.iop_pdira
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC1 == PORT_B)
#define PORT_DTR1_PAR immap->im_ioport.iop_pparb
#define PORT_DTR1_DAT immap->im_ioport.iop_pdatb
#define PORT_DTR1_DIR immap->im_ioport.iop_pdirb
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC1 == PORT_C)
#define PORT_DTR1_PAR immap->im_ioport.iop_pparc
#define PORT_DTR1_DAT immap->im_ioport.iop_pdatc
#define PORT_DTR1_DIR immap->im_ioport.iop_pdirc
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC1 == PORT_D)
#define PORT_DTR1_PAR immap->im_ioport.iop_ppard
#define PORT_DTR1_DAT immap->im_ioport.iop_pdatd
#define PORT_DTR1_DIR immap->im_ioport.iop_pdird
#endif
...
#define PORT_DTR2_PAR immap->im_ioport.iop_ppara
#define PORT_DTR2_DAT immap->im_ioport.iop_pdata
#define PORT_DTR2_DIR immap->im_ioport.iop_pdira
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC2 == PORT_B)
#define PORT_DTR2_PAR immap->im_ioport.iop_pparb
#define PORT_DTR2_DAT immap->im_ioport.iop_pdatb
#define PORT_DTR2_DIR immap->im_ioport.iop_pdirb
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC2 == PORT_C)
#define PORT_DTR2_PAR immap->im_ioport.iop_pparc
#define PORT_DTR2_DAT immap->im_ioport.iop_pdatc
#define PORT_DTR2_DIR immap->im_ioport.iop_pdirc
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC2 == PORT_D)
#define PORT_DTR2_PAR immap->im_ioport.iop_ppard
#define PORT_DTR2_DAT immap->im_ioport.iop_pdatd
#define PORT_DTR2_DIR immap->im_ioport.iop_pdird
#endif
...
#define PORT_DTR3_PAR immap->im_ioport.iop_ppara
#define PORT_DTR3_DAT immap->im_ioport.iop_pdata
#define PORT_DTR3_DIR immap->im_ioport.iop_pdira
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC3 == PORT_B)
#define PORT_DTR3_PAR immap->im_ioport.iop_pparb
#define PORT_DTR3_DAT immap->im_ioport.iop_pdatb
#define PORT_DTR3_DIR immap->im_ioport.iop_pdirb
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC3 == PORT_C)
#define PORT_DTR3_PAR immap->im_ioport.iop_pparc
#define PORT_DTR3_DAT immap->im_ioport.iop_pdatc
#define PORT_DTR3_DIR immap->im_ioport.iop_pdirc
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC3 == PORT_D)
#define PORT_DTR3_PAR immap->im_ioport.iop_ppard
#define PORT_DTR3_DAT immap->im_ioport.iop_pdatd
#define PORT_DTR3_DIR immap->im_ioport.iop_pdird
#endif
...
#define PORT_DTR4_PAR immap->im_ioport.iop_ppara
#define PORT_DTR4_DAT immap->im_ioport.iop_pdata
#define PORT_DTR4_DIR immap->im_ioport.iop_pdira
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC4 == PORT_B)
#define PORT_DTR4_PAR immap->im_ioport.iop_pparb
#define PORT_DTR4_DAT immap->im_ioport.iop_pdatb
#define PORT_DTR4_DIR immap->im_ioport.iop_pdirb
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC4 == PORT_C)
#define PORT_DTR4_PAR immap->im_ioport.iop_pparc
#define PORT_DTR4_DAT immap->im_ioport.iop_pdatc
#define PORT_DTR4_DIR immap->im_ioport.iop_pdirc
#endif
#if (CONFIG_UART_DTR_CONTROL_SCC4 == PORT_D)
#define PORT_DTR4_PAR immap->im_ioport.iop_ppard
#define PORT_DTR4_DAT immap->im_ioport.iop_pdatd
#define PORT_DTR4_DIR immap->im_ioport.iop_pdird
#endif
...
#define SCC_IDX_BASE	SCC_NUM_BASE	/* table index */
#else	/* !CONFIG_PM826 */
...
/*
 * hwuang, 11/18/04
 * we don't use SMC2 for UART mode
 */
#if !defined(CONFIG_OLC8260) && !defined(CONFIG_ONU8260)
#if USE_SMC2
...
/*
 * hwuang, 11/18/04
 * we don't use SCC1, or SCC2 for UART mode
 */
#if !defined(CONFIG_OLC8260) && !defined(CONFIG_ONU8260)
...
#endif
#if	defined(CONFIG_PM826)
#ifndef CONFIG_SCC3_ENET
	{ 0,     0, PROFF_SCC3, SIU_INT_SCC3,   0, SCC_NUM_BASE + 2},    /* SCC3 ttyS4 */
#endif
#ifndef CONFIG_SCC4_ENET
	{ 0,     0, PROFF_SCC4, SIU_INT_SCC4,   0, SCC_NUM_BASE + 3},    /* SCC4 ttyS5 */
#endif
#endif  /* CONFIG_PM826 */
};
...
static void change_speed(ser_info_t *info)
{
	...
	info->timeout = (TX_BUF_SIZE*TX_NUM_FIFO*HZ*(bits+2))/baud_rate;
...
#define RELEVANT_IFLAG(iflag) (iflag & (IGNBRK|BRKINT|IGNPAR|PARMRK|INPCK))
	...
	m8260_cpm_setbrg(rs_brg_map[info->state->smc_scc_num], baud_rate);
...
int __init rs_8xx_init(void)
{
	...
	*/
	...
	/* Configure SMC1 & SMC2, SCC1...SCC4 on PM826.
	 * --------------------------
	 *	Port D,  8 - SMC1 RxD	0x00800000	i=0 o=0
	 *	Port D,  9 - SMC1 TxD	0x00400000	i=1 o=0
	 * --------------------------
	 *	Port D,  4 - SMC2 RxD	0x08000000	i=0 o=1
	 *	Port C, 15 - SMC2 TxD	0x00010000	i=1 o=0
	 * --------------------------
	 *	Port D, 31 - SCC1 RxD	0x00000001	i=0 o=0
	 *	Port B, 28 - SCC1 TxD	0x00000008	i=1 o=1
	 *	Port D, 29 - SCC1 RTS
	 *	Port C, 14 - SCC1 DCD
	 *	Port C, 29 - SCC1 CTS
	 * --------------------------
	 *	Port B, 15 - SCC2 RxD	0x00010000	i=0 o=0
	 *	Port D, 27 - SCC2 TxD	0x00000010	i=1 o=0
	 *	Port D, 26 - SCC2 RTS
	 *	Port C, 12 - SCC2 DCD
	 *	Port C, 28 - SCC2 CTS
	 * --------------------------
	 *	Port B, 14 - SCC3 RxD	0x00020000	i=0 o=0
	 *	Port B,  8 - SCC3 TxD	0x00800000	i=1 o=1
	 *	Port D, 23 - SCC3 RTS
	 *	Port C, 10 - SCC3 DCD
	 *	Port C, 11 - SCC3 CTS
	 * --------------------------
	 *	Port D, 22 - SCC4 RxD	0x00000200	i=0 o=0
	 *	Port D, 21 - SCC4 TxD	0x00000400	i=1 o=0
	 *	Port D, 20 - SCC4 RTS
	 *	Port C,  8 - SCC4 DCD
	 *	Port C,  9 - SCC4 CTS
	 */
	io->iop_ppard |=  0x08C00611;
	io->iop_pdird |=  0x00400410;
	io->iop_pdird &= ~0x08800201;
	io->iop_psord |=  0x08000611;
	io->iop_psord &= ~0x00C00611;

	io->iop_pparc |=  0x00010000;
	io->iop_pdirc |=  0x00010000;
	io->iop_psorc &= ~0x00010000;

	io->iop_pparb |=  0x00830008;
	io->iop_pdirb |=  0x00800008;
	io->iop_pdirb &= ~0x00030000;
	io->iop_psorb |=  0x00800008;
	io->iop_psorb &= ~0x00030000;

	/* Wire BRG7 to SMC1 and BRG8 to SMC2 */
	immap->im_cpmux.cmx_smr = 0x11;

	/* Wire BRG1...4 to SCC1...4 (NMSI) */
	immap->im_cpmux.cmx_scr = 0x0009121B;
#endif	/* CONFIG_PM826 */
#else
	io->iop_pparb |= 0x008b0000;
	io->iop_pdirb |= 0x00880000;
	...
	*/
	 ...
	 */
	iobits = 0
#ifdef CONFIG_UART_CD_CONTROL_SCC1
		| 0x00020000	/* PC14 */
#endif
#ifdef CONFIG_UART_CD_CONTROL_SCC2
		| 0x00080000	/* PC12 */
#endif
#ifdef CONFIG_UART_CD_CONTROL_SCC3
		| 0x00200000	/* PC10 */
#endif
#ifdef CONFIG_UART_CD_CONTROL_SCC4
		| 0x00800000	/* PC8 */
#endif
		;
	io->iop_pparc |= iobits;
	 ...
	 */
	iobits = 0
#if defined(CONFIG_UART_CTS_CONTROL_SCC1) && (CONFIG_CTS1_PIN == 15)
		| (1 << (31 - 15))	/* PC15 */
#endif
#if defined(CONFIG_UART_CTS_CONTROL_SCC2) && (CONFIG_CTS2_PIN == 13)
		| (1 << (31 - 13))	/* PC13 */
#endif
#ifdef CONFIG_UART_CTS_CONTROL_SCC3
		| (1 << (31 - 11))	/* PC11 */
	...
	iobits = 0
#if defined(CONFIG_UART_CTS_CONTROL_SCC1) && (CONFIG_CTS1_PIN == 29)
		| (1 << (31 - 29))	/* PC29 */
#endif
#if defined(CONFIG_UART_CTS_CONTROL_SCC2) && (CONFIG_CTS2_PIN == 28)
		| (1 << (31 - 28))	/* PC28 */
#endif
		;
	io->iop_pparc |= iobits;
	 ...
	 */
	iobits = 0
#ifdef CONFIG_UART_RTS_CONTROL_SCC1
		| (1 << (31 - 29))	/* PD29 */
#endif
#ifdef CONFIG_UART_RTS_CONTROL_SCC2
		| (1 << (31 - 26))	/* PD26 */
#endif
#ifdef CONFIG_UART_RTS_CONTROL_SCC3
		| (1 << (31 - 23))	/* PD23 */
#endif
#ifdef CONFIG_UART_RTS_CONTROL_SCC4
		| (1 << (31 - 20))	/* PD20 */
#endif
		;
	io->iop_ppard |= iobits;
	...
	for (i = 0, state = rs_table; i < NR_PORTS; i++,state++) {
		...
		state->icount.overrun = state->icount.brk = 0;
 		printk (KERN_INFO "ttyS%d on %s%d at 0x%04x, BRG%d\n",
 			...
 			rs_brg_map[state->smc_scc_num] + 1);
#ifdef CONFIG_SERIAL_CONSOLE
		...
		if (info) {
			...
			*/
			m8260_cpm_setbrg(rs_brg_map[state->smc_scc_num],
							baud_table[baud_idx]);
...
static int __init serial_console_setup(struct console *co, char *options)
{
	...
	*/
	...
	/* Set up the baud rate generator.
	*/
	m8260_cpm_setbrg(rs_brg_map[ser->smc_scc_num], bd->bi_baudrate);
