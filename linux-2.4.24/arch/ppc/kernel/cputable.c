...
struct cpu_spec	cpu_specs[] = {
    ...
    {	/* 750CXe rev 3.x (83311) */
    	0xfffffff0, 0x00083310, "750CXe (3.x)",
    	CPU_FTR_SPLIT_ID_CACHE | CPU_FTR_CAN_DOZE | CPU_FTR_USE_TB |
	...
	0xffff0000, 0x00810000, "82xx (Hip3)",
	CPU_FTR_SPLIT_ID_CACHE | CPU_FTR_CAN_DOZE | CPU_FTR_USE_TB,
	COMMON_PPC,
	32, 32,
	__setup_cpu_603
    ...
    {	/* 82xx (Hip4 603e cores) */
	0xffff0000, 0x80810000, "82xx (Hip4)",
	CPU_FTR_SPLIT_ID_CACHE | CPU_FTR_CAN_DOZE | CPU_FTR_USE_TB,
	COMMON_PPC,
	32, 32,
	__setup_cpu_603
    ...
    {	/* 5xxx (5100 and 5200 are both 603e cores) */
	0xffff0000, 0x80820000, "5xxx",
	CPU_FTR_SPLIT_ID_CACHE | CPU_FTR_CAN_DOZE | CPU_FTR_USE_TB,
	COMMON_PPC,
	32, 32,
	__setup_cpu_603
