...
extern void mpc5xxx_psc_console_init(void);
extern void mpc5xxx_psc_rs_init(void);
extern void sicc_console_init(void);
extern void uartlite_serial_console_init(void);
...
retry_open:
	...
	if (device == CONSOLE_DEV) {
		...
		noctty = 0; /* JieHan to support Busybox Control-C 09/08/2005 */
	}
#endif
...
void __init console_init(void)
{
	...
	uartlite_serial_console_init();
#endif
#ifdef CONFIG_PPC_5xxx_PSC_CONSOLE
	mpc5xxx_psc_console_init();
#endif
}
