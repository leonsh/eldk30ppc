...
#ifdef CONFIG_I2C_ALGO8260
	extern int i2c_algo_8260_init(void);
	extern int i2c_pm826_init(void);
#endif
...
int __init i2c_init_all(void)
{
	...
	/* --------------------- 8240 -------- */
#ifdef CONFIG_I2C_ALGO8240
	i2c_algo_8240_init();
#endif
#ifdef CONFIG_I2C_CU824
	i2c_cu824_init();
#endif
