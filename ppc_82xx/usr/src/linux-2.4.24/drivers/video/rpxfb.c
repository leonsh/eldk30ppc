 ...
 *
 * LCD frame buffer driver for PowerPC MPC823 family.
 *
 * Original author: Dan Malek <dan@embeddededge.com>
 *
 * Other work by: Paul Mundt <lethal@linux-sh.org> 
 *
 * Copyright (C) 1999-2000 Dan Malek.
