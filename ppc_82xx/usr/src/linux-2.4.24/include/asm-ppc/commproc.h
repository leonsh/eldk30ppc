...
int		m8xx_cpm_dpfree(uint start_addr);
...
#if defined(CONFIG_RPXLITE) || defined(CONFIG_RMU)
/* This ENET stuff is for the MPC850 with ethernet on SCC2.  Some of
 * this may be unique to the RPX-Lite configuration.
 * Note TENA is on Port B for RPX-Lite, but on
 * Port C[14] for RMU (Yair Raz)
 */
...
/*
 * The RMU uses Ethernet, SPI and I2C. Enable uCode patch.
 */
#ifdef CONFIG_UCODE_PATCH
# define USE_IIC_PATCH			/* We need the I²C µCode Patch */
#else
# undef  USE_IIC_PATCH			/* Don't need the I²C µCode Patch */
#endif

#endif	/* CONFIG_RPXLITE, CONFIG_RMU */
...
/***  TQM823L/M, TQM850L/M  *******************************************/
    ...
    defined(CONFIG_TQM823M) || defined(CONFIG_TQM850M)
/* Bits in parallel I/O port registers that have to be set/cleared
 * to configure the pins for SCC1 use.
 */
...
#endif	/* CONFIG_TQM823L/M, CONFIG_TQM850L/M */
...
/***  TQM855L/M, TQM860L/M, CONFIG_TQM862M  ***************************/

#if defined(CONFIG_TQM855L) || defined(CONFIG_TQM860L) || \
...
#endif	/* CONFIG_TQM855L/M, CONFIG_TQM860L/M, CONFIG_TQM862M */
