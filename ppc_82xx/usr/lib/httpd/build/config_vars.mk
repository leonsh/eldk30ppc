...
KRBDIR = /opt/eldk/build/ppc-2004-02-16/work/ppc_82xx/usr/kerberos
...
EXTRA_CXXFLAGS =
EXTRA_LDFLAGS = -L/opt/eldk/build/ppc-2004-02-16/work/ppc_82xx/usr/lib
EXTRA_LIBS = -lz
EXTRA_INCLUDES = -I/opt/eldk/build/ppc-2004-02-16/work/ppc_82xx/usr/include -I. -I$(srcdir) -I$(top_builddir)/os/$(OS_DIR) -I$(top_srcdir)/os/$(OS_DIR) -I$(top_builddir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_builddir)/modules/http -I$(top_srcdir)/modules/http -I$(top_builddir)/modules/proxy -I$(top_srcdir)/modules/proxy -I$(top_builddir)/modules/filters -I$(top_srcdir)/modules/filters -I$(top_builddir)/include -I$(top_srcdir)/include -I/usr/include/openssl -I$(top_srcdir)/modules/dav/main
